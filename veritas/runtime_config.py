...
class GeminiSettings:
    ...
    def from_env(cls) -> "GeminiSettings":
        ...
        return cls(
            ...
            timeout_seconds=float(os.getenv("VERITAS_LLM_TIMEOUT_SECONDS", "30")),
            temperature=float(os.getenv("VERITAS_LLM_TEMPERATURE", "0.2")),
            max_tokens=int(os.getenv("VERITAS_LLM_MAX_TOKENS", "350")),
