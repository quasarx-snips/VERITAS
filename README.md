...
Then open `outputs/prototype_model/VERITAS_demo_report.html`. It presents all 20 supplied sample runs, each with a visual comparison, actual verdict/gate, evidence panel, and human-readable report with image previews. It also creates a contact sheet, decision trace, spatial view, and a false-alarm-defense walkthrough.
